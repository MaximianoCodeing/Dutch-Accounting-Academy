    ...
    lessons: [
      {
        ...
        theory: {
          pt: "RESUMO\nO Conceptual Framework não é uma norma em si — é o ponto de referência (reference point) que serve de base a todas as normas IFRS. Quando uma situação concreta não está coberta por nenhuma norma específica, é ao Framework que se recorre para exercer 'judgement' (julgamento profissional) com 'guidance' (orientação) consistente com a lógica geral do sistema.\n\nKEY CONCEPTS\nFinancial reporting (relato financeiro) é o conceito mais amplo — inclui tudo o que uma empresa comunica sobre a sua posição financeira. As financial statements (demonstrações financeiras) são o produto mais formal desse relato: balanço, demonstração de resultados, notas. O Framework organiza a construção de informação financeira em quatro etapas sequenciais: Recognition → Measurement → Presentation → Disclosure. Um elemento primeiro é reconhecido (entra nas contas), depois é mensurado (ganha um valor), depois é apresentado (aparece no sítio certo da demonstração) e por fim é divulgado (explicado em nota, se necessário).\n\nVOCABULÁRIO TÉCNICO\nRecognition — Reconhecimento — Identificar e registar um elemento nas demonstrações financeiras quando os critérios aplicáveis são cumpridos.\nMeasurement — Mensuração — Determinar o valor monetário pelo qual o elemento será reconhecido.\nPresentation — Apresentação — Determinar como e onde a informação aparece nas demonstrações financeiras.\nDisclosure — Divulgação — Informação adicional apresentada nas notas às demonstrações financeiras.\nPrudence — Prudência — Exercer cautela ao fazer julgamentos em condições de incerteza, sem sobrestimar ativos/proveitos nem subestimar passivos/gastos.\nJudgement — Julgamento — A decisão profissional necessária quando a norma não dá uma resposta mecânica única.\nGuidance — Orientação — As indicações (do Framework ou de uma norma) que apoiam esse julgamento.\nFair value — Justo valor — O preço que se receberia pela venda de um ativo (ou pago para transferir um passivo) numa transação normal entre participantes de mercado.\nConservative approach — Abordagem conservadora — Tendência para não reconhecer proveitos ou ativos até haver confirmação suficiente, associada à prudência.\n\nEXEMPLO PRÁTICO — adiantamento de cliente\nUma empresa recebe de um cliente um pagamento adiantado (advance payment) antes de prestar o serviço. Apesar de o dinheiro já estar na conta bancária, esse valor NÃO é reconhecido imediatamente como revenue (rédito). A razão está no Recognition: a empresa ainda tem uma obrigação por cumprir — prestar o serviço — pelo que o valor recebido é reconhecido como um passivo (liability), tipicamente 'deferred revenue' ou 'contract liability', não como proveito. Só quando o serviço for efetivamente prestado (a obrigação satisfeita — 'satisfy' the performance obligation) é que o valor passa de passivo a revenue. Isto protege creditors, suppliers e shareholders de uma imagem de profitability artificialmente inflacionada por dinheiro que ainda pode ter de ser devolvido.\n\nKEY TAKEAWAYS\n— O Conceptual Framework é o ponto de referência para julgamento, não uma norma com força obrigatória direta.\n— As quatro etapas — Recognition, Measurement, Presentation, Disclosure — organizam toda a lógica de relato financeiro.\n— Prudência não significa subestimar sistematicamente — significa não sobrestimar em condições de incerteza.\n— Um adiantamento recebido é passivo (obrigação de prestar o serviço), não revenue, até a obrigação estar satisfeita.",
          en: "SUMMARY\nThe Conceptual Framework is not a standard itself — it's the reference point underlying all IFRS standards. When a specific situation isn't covered by any particular standard, the Framework is what you turn to for judgement, guided by the overall logic of the system.\n\nKEY CONCEPTS\nFinancial reporting is the broadest concept — everything a company communicates about its financial position. Financial statements are the most formal output of that reporting: balance sheet, income statement, notes. The Framework organises financial information through four sequential stages: Recognition → Measurement → Presentation → Disclosure. An item is first recognised (enters the accounts), then measured (given a monetary value), then presented (shown in the right place in the statements), and finally disclosed (explained in the notes, if needed).\n\nTECHNICAL VOCABULARY\nRecognition — Identifying and recording an item in the financial statements once the applicable criteria are met.\nMeasurement — Determining the monetary amount at which the item will be recognised.\nPresentation — Determining how and where information appears in the financial statements.\nDisclosure — Additional information presented in the notes to the financial statements.\nPrudence — Exercising caution when making judgements under uncertainty, neither overstating assets/income nor understating liabilities/expenses.\nJudgement — The professional decision needed when a standard doesn't give one mechanical answer.\nGuidance — The direction (from the Framework or a standard) that supports that judgement.\nFair value — The price that would be received to sell an asset (or paid to transfer a liability) in an orderly transaction between market participants.\nConservative approach — A tendency not to recognise income or assets until there's sufficient confirmation, linked to prudence.\n\nWORKED EXAMPLE — customer advance payment\nA company receives an advance payment from a customer before performing the service. Even though the cash is already in the bank, that amount is NOT immediately recognised as revenue. The reason lies in Recognition: the company still has an obligation to fulfil — performing the service — so the amount received is recognised as a liability, typically 'deferred revenue' or a 'contract liability', not as income. Only once the service is actually performed (the performance obligation is satisfied) does the amount move from liability to revenue. This protects creditors, suppliers and shareholders from a picture of profitability artificially inflated by cash that might still need to be returned.\n\nKEY TAKEAWAYS\n— The Conceptual Framework is the reference point for judgement, not a directly binding standard.\n— The four stages — Recognition, Measurement, Presentation, Disclosure — structure the entire logic of financial reporting.\n— Prudence doesn't mean systematically understating — it means not overstating under uncertainty.\n— An advance payment received is a liability (obligation to perform the service), not revenue, until the obligation is satisfied.",
          nl: "SAMENVATTING\nHet Conceptual Framework is geen standaard op zich — het is het referentiepunt achter alle IFRS-standaarden. Wanneer een specifieke situatie door geen enkele standaard wordt gedekt, biedt het Framework de basis voor 'judgement' (professioneel oordeel), consistent met de algemene logica van het stelsel.\n\nKERNBEGRIPPEN\nFinancial reporting is het breedste begrip — alles wat een onderneming communiceert over haar financiële positie. Financial statements zijn het meest formele resultaat daarvan: balans, resultatenrekening, toelichting. Het Framework ordent financiële informatie in vier opeenvolgende stappen: Recognition → Measurement → Presentation → Disclosure. Een post wordt eerst opgenomen (recognition), daarna gewaardeerd (measurement), daarna gepresenteerd (presentation), en ten slotte toegelicht (disclosure), indien nodig.\n\nTECHNISCH VOCABULAIRE\nRecognition — Een post in de jaarrekening opnemen zodra aan de toepasselijke criteria is voldaan.\nMeasurement — Het geldbedrag bepalen waartegen de post wordt opgenomen.\nPresentation — Bepalen hoe en waar informatie in de jaarrekening verschijnt.\nDisclosure — Aanvullende informatie in de toelichting bij de jaarrekening.\nPrudence — Voorzichtigheid betrachten bij oordeelsvorming onder onzekerheid, zonder activa/baten te overschatten of verplichtingen/lasten te onderschatten.\nJudgement — De professionele beslissing die nodig is wanneer een standaard geen mechanisch eenduidig antwoord geeft.\nGuidance — De richtlijnen (van het Framework of een standaard) die dat oordeel ondersteunen.\nFair value — De prijs die zou worden ontvangen bij verkoop van een actief (of betaald bij overdracht van een verplichting) in een ordelijke transactie tussen marktpartijen.\nConservative approach — De neiging om baten of activa pas op te nemen na voldoende bevestiging, verbonden met voorzichtigheid.\n\nUITGEWERKT VOORBEELD — vooruitbetaling van een klant\nEen onderneming ontvangt een vooruitbetaling van een klant vóórdat de dienst is geleverd. Ook al staat het geld al op de bankrekening, dat bedrag wordt NIET meteen als omzet (revenue) opgenomen. De reden ligt in Recognition: de onderneming heeft nog een verplichting — de dienst leveren — dus het ontvangen bedrag wordt opgenomen als een verplichting (liability), doorgaans 'deferred revenue' of een 'contract liability', niet als opbrengst. Pas wanneer de dienst daadwerkelijk is geleverd (de prestatieverplichting is 'satisfied') verschuift het bedrag van verplichting naar omzet. Dit beschermt schuldeisers, leveranciers en aandeelhouders tegen een beeld van winstgevendheid dat kunstmatig is opgeblazen door geld dat mogelijk nog terugbetaald moet worden.\n\nKERNPUNTEN\n— Het Conceptual Framework is het referentiepunt voor oordeelsvorming, geen direct bindende standaard.\n— De vier stappen — Recognition, Measurement, Presentation, Disclosure — structureren de hele logica van financiële verslaggeving.\n— Voorzichtigheid betekent niet systematisch onderschatten — het betekent niet overschatten onder onzekerheid.\n— Een ontvangen vooruitbetaling is een verplichting (verplichting om de dienst te leveren), geen omzet, totdat de verplichting is voldaan.",
        },
        flashcard: {
...
const TASK_MIN_LEVEL = { t1: 1, t2: 1, t3: 1, t4: 1, t5: 1, t6: 1 };
