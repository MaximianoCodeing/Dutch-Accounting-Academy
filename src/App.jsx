...
const STR = {
  pt: {
    ...
    journal_check: "Verificar lançamento",
  ...
  nl: {
    ...
    journal_check: "Boeking controleren",
...
const COMPANY_TASKS = [
  {
    ...
    exercise: {
      scenario: {
        pt: "Pratica com uma das faturas: venda de €1.000 (sem BTW) a um cliente holandês, com 21% de BTW. Lança as 3 linhas do journaalpost — escolhe a conta, o lado (debet/credit) e o valor de cada linha.",
        en: "Practise with one of the invoices: a €1,000 sale (excl. VAT) to a Dutch customer, with 21% VAT. Post the 3 lines of the journal entry — pick the account, the side (debet/credit) and the amount for each line.",
        nl: "Oefen met één van de facturen: een verkoop van €1.000 (excl. BTW) aan een Nederlandse klant, met 21% BTW. Boek de 3 regels van de journaalpost — kies de rekening, de kant (debet/credit) en het bedrag per regel.",
      },
      accounts: [
        { pt: "Debiteuren", en: "Debiteuren", nl: "Debiteuren" },
        { pt: "Crediteuren", en: "Crediteuren", nl: "Crediteuren" },
        { pt: "Omzet", en: "Omzet", nl: "Omzet" },
        { pt: "Te betalen omzetbelasting", en: "Te betalen omzetbelasting", nl: "Te betalen omzetbelasting" },
        { pt: "Voorbelasting", en: "Voorbelasting", nl: "Voorbelasting" },
        { pt: "Bank", en: "Bank", nl: "Bank" },
      ],
      lines: [
...
function JournalExercise({ exercise, lang, t, pal, onSolved, solved }) {
  ...
  return (
    <div className="mb-4">
      ...
      <button
        onClick={verify}
        disabled={solved || rows.some((r) => r.account === "" || r.side === "" || r.amount === "")}
...
function TaskModal({ task, lang, t, pal, onClose, onComplete, done }) {
  ...
  const needsExercise = !!task.exercise;
  ...
  return (
    <div key={task.id} className="fixed inset-0 z-30 flex items-end sm:items-center justify-center p-0 sm:p-6"
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        {task.exercise ? (
          <JournalExercise exercise={task.exercise} lang={lang} t={t} pal={pal} solved={done || exerciseSolved} onSolved={() => setExerciseSolved(true)} />
        ) : (
