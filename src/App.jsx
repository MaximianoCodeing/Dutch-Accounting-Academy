  ...
  <div class="wrap">
    <nav>
      ...
      <div style="display:flex; gap:10px;">
        <a href="#enter" class="btn btn-ghost">Já sou aluno</a>
        <a href="#enter" class="btn btn-primary">Começar grátis</a>
      </div>
    </nav>
    ...
    <section class="hero">
      <div>
        ...
        <div class="hero-ctas">
          ...
          <a href="#enter" class="btn btn-ghost">Ver currículo completo</a>
        </div>
      </div>
      <div class="hero-card">
    ...
    <section class="section" id="cursos">
      ...
      <div class="courses">
        <a href="#enter" class="course-card">
    ...
    <section class="cta-band">
      ...
      <a href="#enter" class="btn btn-primary">Criar conta grátis →</a>
    </section>
...
function LandingPage({ onEnter }) {
  ...
  useEffect(() => {
    ...
    if (!el) return;
    const handler = (e) => {
      const link = e.target.closest('a[href="#enter"]');
      if (link) {
        e.preventDefault();
        onEnter();
      }
