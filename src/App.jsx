...
const LANDING_BODY = `
  ...
  <nav>
    <div class="nav-inner">
      ...
      <a href="#enter" class="nav-cta">Entrar →</a>
    </div>
  </nav>
  ...
  <section class="hero">
    ...
    <div class="hero-ctas">
      <a href="#enter" class="btn btn-primary">Começar agora</a>
  ...
  <section class="section" id="modulos">
    ...
    <div class="module-row">
      <a href="#enter" class="module-card"><div class="icon">BT</div><h3>BTW</h3><p>IVA neerlandês, reverse-charge, OSS e faturação.</p></a>
      <a href="#enter" class="module-card"><div class="icon">Vp</div><h3>Corporate Tax</h3><p>Vpb, participation exemption, innovatiebox.</p></a>
      <a href="#enter" class="module-card"><div class="icon">Pr</div><h3>Payroll</h3><p>Loonheffing, regra dos 30%, contratos.</p></a>
      <a href="#enter" class="module-card"><div class="icon">GA</div><h3>Dutch GAAP</h3><p>BW2 Titel 9 e demonstrações financeiras.</p></a>
      <a href="#enter" class="module-card"><div class="icon">IF</div><h3>IFRS</h3><p>Conceptual Framework e normas internacionais.</p></a>
      <a href="#enter" class="module-card"><div class="icon">ME</div><h3>Modo Empresa</h3><p>Simulações reais, com correção automática.</p></a>
    </div>
  </section>
  ...
  <section class="final">
    ...
    <a href="#enter" class="btn btn-primary">Criar conta →</a>
  </section>
