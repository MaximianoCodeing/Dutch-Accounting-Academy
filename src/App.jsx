...
const STR = {
  pt: {
    ...
    correct: "Correto! Lição marcada como concluída.", incorrect: "Não é bem isso — tenta novamente.",
  ...
  en: {
    ...
    correct: "Correct! Lesson marked as completed.", incorrect: "Not quite — try again.",
  ...
  nl: {
    ...
    correct: "Correct! Les gemarkeerd als voltooid.", incorrect: "Niet helemaal — probeer opnieuw.",
...
const COURSES = [
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        title: { pt: "O plano de contas RGS", en: "The RGS chart of accounts", nl: "Het Referentie GrootboekSchema (RGS)" },
        theory: {
          pt: "Esta é a maior diferença face a Portugal ou ao Brasil. Os Países Baixos não têm um plano de contas obrigatório único; historicamente cada software tinha o seu. Para resolver isso criou-se o RGS (Referentie GrootboekSchema): um plano de contas de referência uniforme com cerca de 2.000 contas, organizado em cinco níveis hierárquicos — verantwoording, hoofdrubriek, rubriek, rekening e mutatie. Cada conta tem um código semântico composto por grupos de três letras (por exemplo, BLimVvp), em vez de apenas um número. Como 2.000 contas é excessivo para uma PME, existe o RGS MKB, uma seleção reduzida com esquemas próprios para ZZP, eenmanszaak/VOF, BV micro e pequena, e fundações.",
          en: "This is the biggest difference from most other countries. The Netherlands has no single mandatory chart of accounts; historically each software package had its own. To fix this, the RGS (Referentie GrootboekSchema) was created: a uniform reference chart of roughly 2,000 accounts, organised in five hierarchical levels — verantwoording, hoofdrubriek, rubriek, rekening and mutatie. Each account carries a semantic code built from three-letter groups (e.g. BLimVvp), rather than just a number. Since 2,000 accounts is far too many for an SME, RGS MKB exists: a reduced selection with dedicated schemes for ZZP, eenmanszaak/VOF, micro and small BVs, and foundations.",
          nl: "Dit is het grootste verschil met veel andere landen. Nederland kent geen verplicht uniform rekeningschema; van oudsher had elk softwarepakket zijn eigen schema. Daarom is het RGS (Referentie GrootboekSchema) ontwikkeld: een uniform referentieschema met circa 2.000 rekeningen, in vijf hiërarchische niveaus — verantwoording, hoofdrubriek, rubriek, rekening en mutatie. Elke rekening heeft een semantische code opgebouwd uit groepjes van drie letters (bijvoorbeeld BLimVvp), in plaats van alleen een nummer. Omdat 2.000 rekeningen te veel is voor het MKB bestaat RGS MKB: een beperkte selectie met aparte schema's voor ZZP, eenmanszaak/VOF, micro- en kleine BV's, en stichtingen.",
        },
        flashcard: {
          front: { pt: "Quantos níveis hierárquicos tem o RGS?", en: "How many hierarchical levels does RGS have?", nl: "Hoeveel hiërarchische niveaus kent RGS?" },
          back: { pt: "Cinco: verantwoording, hoofdrubriek, rubriek, rekening e mutatie.", en: "Five: verantwoording, hoofdrubriek, rubriek, rekening and mutatie.", nl: "Vijf: verantwoording, hoofdrubriek, rubriek, rekening en mutatie." },
        },
        quiz: {
          q: { pt: "Qual a principal função do RGS?", en: "What is the RGS's main purpose?", nl: "Wat is het hoofddoel van RGS?" },
          options: [
            { pt: "Substituir a declaração de BTW", en: "Replacing the VAT return", nl: "De BTW-aangifte vervangen" },
            { pt: "Uniformizar contas para simplificar relato e troca de dados (SBR)", en: "Standardising accounts to simplify reporting and data exchange (SBR)", nl: "Rekeningen uniformeren om rapportage en gegevensuitwisseling (SBR) te vereenvoudigen" },
            { pt: "Calcular automaticamente o Vpb", en: "Automatically calculating Vpb", nl: "Automatisch de Vpb berekenen" },
          ], answer: 1,
        },
      },
      {
...
const CAREER_LEVELS = [
  ...
  { key: "accountant", pt: "Accountant", en: "Accountant", nl: "Accountant", req: { pt: "Nível 12 · Dutch GAAP completo", en: "Level 12 · Dutch GAAP complete", nl: "Niveau 12 · Nederlandse GAAP voltooid" } },
  { key: "senior", pt: "Senior Accountant", en: "Senior Accountant", nl: "Senior Accountant", req: { pt: "Nível 20 · 5 month-end closes", en: "Level 20 · 5 month-end closes", nl: "Niveau 20 · 5 maandafsluitingen" } },
  { key: "controller", pt: "Controller", en: "Controller", nl: "Controller", req: { pt: "Nível 30 · 1 year-end close", en: "Level 30 · 1 year-end close", nl: "Niveau 30 · 1 jaarafsluiting" } },
  { key: "manager", pt: "Finance Manager", en: "Finance Manager", nl: "Finance Manager", req: { pt: "Nível 40 · Gestão de equipa simulada", en: "Level 40 · Simulated team management", nl: "Niveau 40 · Gesimuleerd teammanagement" } },
  { key: "cfo", pt: "CFO", en: "CFO", nl: "CFO", req: { pt: "Nível 50 · Certificação total", en: "Level 50 · Full certification", nl: "Niveau 50 · Volledige certificering" } },
];
...
const COMPANY_TASKS = [
  {
    ...
    brief: {
      pt: "Lança as 12 faturas de venda de julho no verkoopboek. Cada uma gera três linhas: debet Debiteuren pelo total, credit Omzet pelo valor líquido, credit Te betalen omzetbelasting pela BTW. Atenção: duas das faturas são para clientes belgas com número de BTW válido — essas vão a 0% com a menção 'BTW verlegd' e entram na declaração ICP.",
      en: "Post July's 12 sales invoices in the verkoopboek. Each produces three lines: debet Debiteuren for the total, credit Omzet for the net amount, credit Te betalen omzetbelasting for the VAT. Watch out: two invoices are to Belgian customers with valid VAT numbers — those go at 0% marked 'BTW verlegd' and enter the ICP listing.",
      nl: "Boek de 12 verkoopfacturen van juli in het verkoopboek. Elke factuur geeft drie regels: debet Debiteuren voor het totaal, credit Omzet voor het nettobedrag, credit Te betalen omzetbelasting voor de BTW. Let op: twee facturen zijn aan Belgische afnemers met geldig btw-nummer — die gaan tegen 0% met 'BTW verlegd' en horen in de opgaaf ICP.",
    },
  },
  {
...
const CAREER_MIN_LEVEL = [1, 5, 12, 20, 30, 40, 50];
...
/* ============================================================
   PAGES
   ============================================================ */
function DashboardPage({ t, pal, lang, progress, level, careerIndex, missions }) {
        ...
        <div className="md:col-span-2 space-y-5">
          <LedgerPanel pal={pal}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <button className="px-4 py-2 rounded-md text-sm font-medium self-start sm:self-auto shrink-0" style={{ background: pal.orange, color: "#fff", fontFamily: "'Space Grotesk', sans-serif" }}>
...
function QuizWidget({ quiz, lang, t, pal, onCorrect, alreadyDone }) {
  ...
  return (
    <div>
      ...
      <button disabled={selected === null}
        onClick={() => { setChecked(true); setAttempts((a) => a + 1); if (selected === quiz.answer && onCorrect) onCorrect(attempts === 0); }}
...
function CoursesPage({ t, pal, lang, progress, onLessonComplete, onFlashcard }) {
  const [openCourse, setOpenCourse] = useState(COURSES[0].id);
  const [selectedLesson, setSelectedLesson] = useState({ [COURSES[0].id]: 0 });
                ...
                <div className="mt-5 pt-5 grid md:grid-cols-3 gap-6" style={{ borderTop: `1px solid ${pal.border}` }}>
                  ...
                  <div className="md:col-span-2 space-y-5">
                    <div>
                      ...
                      <p className="text-sm leading-relaxed" style={{ color: pal.inkSoft }}>{activeLesson.theory[lang]}</p>
                    </div>
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end sm:items-center justify-center p-0 sm:p-6"
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        <p className="text-sm leading-relaxed mb-5" style={{ color: pal.inkSoft }}>{task.brief[lang]}</p>
...
function ProfilePage({ t, pal, lang, theme, setTheme, setLang, onReset, account, badges }) {
  return (
    <div className="space-y-6">
      <div>
...
export default function App() {
  ...
  const authenticate = async (fn, username, password) => {
    ...
    try {
      ...
      if (remote.progress) {
        // o servidor manda: adota o progresso guardado na conta
        skipNextSync.current = true;
        setProgress({ ...EMPTY_PROGRESS, ...remote.progress });
      } else {
        // conta nova: envia o que já existe neste dispositivo
  ...
  const Page = useMemo(() => {
    switch (tab) {
      case "courses": return <CoursesPage t={t} pal={pal} lang={lang} progress={progress} onLessonComplete={handleLessonComplete} onFlashcard={handleFlashcard} />;
      ...
      case "profile": return <ProfilePage t={t} pal={pal} lang={lang} theme={theme} setTheme={setTheme} setLang={setLang} onReset={handleReset} account={account} badges={badges} />;
      default: return <DashboardPage t={t} pal={pal} lang={lang} progress={progress} level={level} careerIndex={careerIndex} missions={missions} />;
    }
  }, [tab, lang, theme, progress, level, careerIndex, missions, badges, user, authError, authBusy, syncState]);
