                  ...
                  <div className="space-y-1.5">
                      ...
                      return (
                        <div key={i} className="flex items-center gap-1">
                          <button
                            ...
                            className="flex-1 flex items-center gap-2 text-left text-sm px-2.5 py-2 rounded-md transition-colors min-w-0"
                            ...
                            {l.custom && (
                              <span className="text-[9px] px-1 py-0.5 rounded flex-shrink-0" style={{ background: pal.bgAlt, color: pal.muted, fontFamily: "'IBM Plex Mono', monospace" }}>
                                {t.custom_tag}
                              </span>
                            )}
                          </button>
                    ...
                    {account.user && (
                      <button onClick={() => setAddLessonTo(c.id)}
                        ...
                        style={{ color: pal.orange, fontFamily: "'Space Grotesk', sans-serif" }}>
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end sm:items-center justify-center p-0 sm:p-6"
      ...
      <div onClick={(e) => e.stopPropagation()}
        className="w-full sm:max-w-lg max-h-[88vh] overflow-y-auto rounded-t-2xl sm:rounded-lg p-5"
        style={{ background: pal.panel, border: `1px solid ${pal.border}` }}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base font-semibold" style={{ color: pal.ink, fontFamily: "'Space Grotesk', sans-serif" }}>{t.add_lesson_to_course}</h2>
...
const LANDING_BODY = `
  <div class="wrap">
    ...
    <footer>
      <span>Dutch Accounting Academy · feito com 🌱 para quem quer trabalhar na Holanda</span>
