...
const PALETTE = {
  light: {
    bg: "#F7F9FC",        // branco-azulado suave
    bgAlt: "#EEF2F8",
    panel: "#FFFFFF",     // branco puro dos cartões
    ledgerLine: "#E4EAF4",
    ink: "#12203E",       // azul-tinta profundo
    inkSoft: "#3C4E70",
    muted: "#7686A3",
    border: "#DCE4F0",
    orange: "#C8102E",    // vermelho oficial da bandeira — cor primária
    orangeSoft: "#FBE4E6",
    stampRed: "#C8102E",
  ...
  dark: {
    ...
    muted: "#7C8AA8",
    border: "#283655",
    orange: "#F0475D",    // vermelho vivo sobre fundo escuro
    orangeSoft: "#3B1622",
    stampRed: "#F0475D",
    green: "#5B8CF0",     // azul elétrico
    gold: "#F2B84B",
  },
};
...
function Stamp({ label, color, earned, size = "md", pal }) {
  ...
  return (
    <div style={{
      ...
      color: earned ? stampColor : pal.muted, fontFamily: "'Poppins', sans-serif", fontWeight: 700,
...
function LedgerPanel({ children, pal, style, className = "" }) {
  return (
    <div style={{
      background: pal.panel, border: `1px solid ${pal.border}`, borderRadius: 20,
      boxShadow: "0 8px 24px rgba(31,122,77,0.06)",
      ...style,
...
function SectionEyebrow({ children, pal }) {
  return (
    <div className="text-xs font-semibold tracking-widest uppercase mb-2"
      style={{ color: pal.orange, fontFamily: "'Poppins', sans-serif", letterSpacing: "0.12em" }}>
      {children}
    </div>
  );
}
...
function VocabularyPage({ t, pal, lang }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.vocabulary_title}</h1>
...
function DashboardPage({ t, pal, lang, progress, level, careerIndex, missions, onContinue }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.dashboard_title}</h1>
        ...
        {[{ label: t.level, value: String(level), icon: TrendingUp }, { label: t.xp, value: String(progress.xp), icon: Award },
          ...
          <LedgerPanel key={i} pal={pal}>
            <div className="flex items-center gap-2 mb-1" style={{ color: pal.muted }}>
              <s.icon size={15} /><span className="text-xs uppercase tracking-wide" style={{ fontFamily: "'Poppins', sans-serif" }}>{s.label}</span>
            </div>
            <div className="text-2xl font-semibold" style={{ color: pal.ink, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>{s.value}</div>
          </LedgerPanel>
        ))}
      </div>
          ...
          <LedgerPanel pal={pal}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl text-sm font-medium self-start sm:self-auto shrink-0"
                style={{ background: pal.orange, color: "#fff", fontFamily: "'Poppins', sans-serif" }}>
            ...
            <div className="text-xs mt-1.5" style={{ color: pal.muted, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>
            ...
            {missions.daily.map((m, i) => (
              <div key={i}>
                <div className="flex justify-between text-sm mb-1" style={{ color: pal.ink }}>
                  <span>{m.title[lang]}</span><span style={{ color: pal.muted, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>{m.progress}/{m.total}</span>
                </div>
...
function FlashcardWidget({ card, lang, t, pal, onFlip }) {
  ...
  return (
    <div>
      ...
      <div onClick={flip}
        className="cursor-pointer rounded-xl p-6 min-h-[110px] flex items-center justify-center text-center transition-all select-none"
      ...
      <button onClick={flip} className="mt-2 text-xs font-medium uppercase tracking-wide"
        style={{ color: pal.orange, fontFamily: "'Poppins', sans-serif" }}>{t.flip} ↻</button>
    </div>
  );
}
    ...
    <div>
      ...
      <div className="flex items-center gap-2 mt-3">
        <button disabled={selected === null}
          ...
          style={{ background: pal.ink, color: pal.panel, fontFamily: "'Poppins', sans-serif" }}>
          {t.check_answer}
        </button>
      ...
      {checked && quiz.explain && (
        <div className="mt-2 text-xs leading-relaxed px-3 py-2.5 rounded-xl"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.courses_title}</h1>
        ...
        {COURSES.map((c) => {
          ...
          return (
            <LedgerPanel key={c.id} pal={pal}>
              <div className="flex items-center gap-2">
                <button className="flex-1 flex items-center justify-between" onClick={() => setOpenCourse(isOpen ? null : c.id)}>
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: pal.bgAlt, color: pal.orange }}>
                      <Icon size={17} />
                    </div>
                    <div className="text-left">
                      <div className="font-medium flex items-center gap-2" style={{ color: pal.ink }}>
                        {c.title[lang]}
                        {c.custom && (
                          <span className="text-[10px] px-1.5 py-0.5 rounded-xl" style={{ background: pal.bgAlt, color: pal.muted, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>
                            {t.custom_tag}
                          </span>
                        )}
                      </div>
              ...
              {isOpen && (
                <div className="mt-6 pt-2 grid md:grid-cols-3 gap-6">
                  {/* Lesson list */}
                  <div className="space-y-1.5">
                      ...
                      return (
                        <div key={i} className="flex items-center gap-1">
                          <button
                            ...
                            className="flex-1 flex items-center gap-2 text-left text-sm px-2.5 py-2 rounded-xl transition-colors min-w-0"
                            ...
                            {l.custom && (
                              <span className="text-[9px] px-1 py-0.5 rounded-xl flex-shrink-0" style={{ background: pal.bgAlt, color: pal.muted, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>
                                {t.custom_tag}
                              </span>
                            )}
                          </button>
                    ...
                    {account.user && (
                      <button onClick={() => setAddLessonTo(c.id)}
                        ...
                        style={{ color: pal.orange, fontFamily: "'Poppins', sans-serif" }}>
                  ...
                  <div className="md:col-span-2 space-y-5">
                    <div>
                      <div className="text-sm font-semibold mb-2" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>
...
function AddLessonModal({ t, pal, lang, courseId, onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end sm:items-center justify-center p-0 sm:p-6"
      ...
      <div onClick={(e) => e.stopPropagation()}
        className="w-full sm:max-w-lg max-h-[88vh] overflow-y-auto rounded-t-2xl sm:rounded-xl p-5"
        style={{ background: pal.panel, border: `1px solid ${pal.border}` }}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.add_lesson_to_course}</h2>
        ...
        <div className="flex gap-2 mb-4">
          {["pt", "en", "nl"].map((l) => (
            <button key={l} onClick={() => setSourceLang(l)}
              className="flex-1 px-3 py-2 rounded-xl text-xs font-medium uppercase"
              style={{ background: sourceLang === l ? pal.orange : pal.bgAlt, color: sourceLang === l ? "#fff" : pal.inkSoft, fontFamily: "'Poppins', sans-serif" }}>
              {l}
            </button>
          ))}
        </div>
        ...
        <div className="space-y-2">
          ...
          <textarea value={theory} onChange={(e) => setTheory(e.target.value)} placeholder={t.form_theory} rows={5}
            className="w-full px-3 py-2 rounded-xl text-sm outline-none resize-y" style={inputStyle} />
        ...
        <button onClick={submit} disabled={busy}
          className="mt-4 w-full px-4 py-2.5 rounded-xl text-sm font-medium disabled:opacity-50"
          style={{ background: pal.orange, color: "#fff", fontFamily: "'Poppins', sans-serif" }}>
          {busy ? t.form_translating : t.form_save_lesson}
        </button>
      </div>
    </div>
  );
...
function CreateCourseModal({ t, pal, lang, onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end sm:items-center justify-center p-0 sm:p-6"
      style={{ background: "rgba(0,0,0,0.5)" }} onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()}
        className="w-full sm:max-w-xl max-h-[88vh] overflow-y-auto rounded-t-2xl sm:rounded-xl p-5"
        style={{ background: pal.panel, border: `1px solid ${pal.border}` }}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.new_course}</h2>
          <button onClick={onClose} style={{ color: pal.muted }}><X size={18} /></button>
        </div>
        ...
        <div className="space-y-4">
          {lessons.map((l, i) => (
            <div key={i} className="p-3 rounded-xl space-y-2" style={{ background: pal.bgAlt, border: `1px solid ${pal.border}` }}>
        ...
        <button onClick={addLesson} className="mt-3 text-xs font-medium" style={{ color: pal.orange, fontFamily: "'Poppins', sans-serif" }}>
          + {t.form_add_lesson}
        </button>
    ...
    <div>
      ...
      <div className="space-y-2">
        {rows.map((row, i) => {
          ...
          return (
            <div key={i} className="flex flex-wrap items-center gap-2 p-2 rounded-xl" style={{ border: `1.5px solid ${borderColor}`, background: pal.bgAlt }}>
              <select
                value={row.account}
                onChange={(e) => updateRow(i, { account: e.target.value })}
                className="flex-1 min-w-[140px] px-2 py-1.5 rounded-xl text-sm"
              ...
              <div className="flex rounded-xl overflow-hidden flex-shrink-0" style={{ border: `1px solid ${pal.border}` }}>
              ...
              <input
                ...
                className="w-24 px-2 py-1.5 rounded-xl text-sm flex-shrink-0"
      ...
      <div className="flex items-center gap-2 mt-3">
        ...
        <button
          onClick={reset}
          className="px-4 py-1.5 rounded-xl text-sm font-medium"
          style={{ border: `1.5px solid ${pal.border}`, color: pal.inkSoft, fontFamily: "'Poppins', sans-serif" }}>
          {t.journal_retry}
        </button>
      </div>
    ...
    <div className="mb-4">
      ...
      <div className="flex items-center gap-2 mt-3">
        <button
          ...
          disabled={index === 0}
          className="px-3 py-1.5 rounded-xl text-xs font-medium disabled:opacity-30"
          style={{ border: `1.5px solid ${pal.border}`, color: pal.inkSoft, fontFamily: "'Poppins', sans-serif" }}>
          ← {t.journal_prev}
        </button>
        <button
    ...
    <div>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <input
          ...
          className="w-32 px-2 py-1.5 rounded-xl text-sm"
          style={{
...
function TaskModal({ task, lang, t, pal, onClose, onComplete, done }) {
  ...
  return (
    <div key={task.id} className="fixed inset-0 z-30 flex items-end sm:items-center justify-center p-0 sm:p-6"
      ...
      <div onClick={(e) => e.stopPropagation()}
        className="w-full sm:max-w-lg max-h-[85vh] overflow-y-auto rounded-t-2xl sm:rounded-xl p-5"
        style={{ background: pal.panel, border: `1px solid ${pal.border}` }}>
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <h2 className="text-base font-semibold leading-snug"
              style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{task.title[lang]}</h2>
          </div>
        ...
        {needsExercise ? (
          ...
          <div className="text-xs mb-4 px-3 py-2.5 rounded-xl" style={{ background: pal.orangeSoft, color: pal.inkSoft }}>
            {t.demo_note}
          </div>
        )}
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button onClick={onComplete} disabled={!canComplete}
            ...
            style={{ background: done ? pal.green : pal.orange, color: "#fff", fontFamily: "'Poppins', sans-serif" }}>
...
function CompanyPage({ t, pal, lang, progress, level, careerIndex, onTaskComplete, account, onRefreshCustom }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.company_title}</h1>
        ...
        <LedgerPanel pal={pal} className="md:col-span-2">
          ...
          <div className="space-y-2">
            {COMPANY_TASKS.map((task) => {
              ...
              return (
                <div key={task.id} className="px-3 py-3 rounded-xl" style={{ background: pal.bgAlt, opacity: locked ? 0.55 : 1 }}>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: pal.panel, color: done ? pal.green : pal.orange }}>
                      {locked ? <Lock size={14} /> : <Icon size={14} />}
                    </div>
                    <span className="text-sm leading-snug flex-1 flex items-center gap-2" style={{ color: pal.ink }}>
                      {task.title[lang]}
                      {task.custom && (
                        <span className="text-[10px] px-1.5 py-0.5 rounded-xl flex-shrink-0" style={{ background: pal.panel, color: pal.muted, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>
                          {t.custom_tag}
                        </span>
                      )}
                    </span>
                  ...
                  <div className="flex items-center justify-between gap-3 mt-2.5 pl-11">
                    ...
                    {done ? (
                      <button onClick={() => setOpenTask(task)}
                        ...
                        style={{ color: pal.green, background: "transparent", fontFamily: "'Poppins', sans-serif" }}>
                        <CheckCircle2 size={15} /> {t.completed} · {t.practice_more}
                      </button>
                    ) : (
                      <button disabled={locked} onClick={() => setOpenTask(task)}
                        className="text-xs font-medium px-3 py-1.5 rounded-xl"
                        style={{ background: locked ? "transparent" : pal.orange, color: locked ? pal.muted : "#fff", fontFamily: "'Poppins', sans-serif" }}>
              ...
              {CAREER_LEVELS.slice().reverse().map((lvl, ri) => {
                ...
                return (
                  <div key={lvl.key} className="relative flex items-start gap-3">
                    ...
                    <div className="ml-2">
                      <div className="text-sm font-medium" style={{ color: state === "locked" ? pal.muted : pal.ink, fontFamily: "'Poppins', sans-serif" }}>
...
function CreateTaskModal({ t, pal, lang, onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end sm:items-center justify-center p-0 sm:p-6"
      style={{ background: "rgba(0,0,0,0.5)" }} onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()}
        className="w-full sm:max-w-md max-h-[85vh] overflow-y-auto rounded-t-2xl sm:rounded-xl p-5"
        style={{ background: pal.panel, border: `1px solid ${pal.border}` }}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.new_task}</h2>
          <button onClick={onClose} style={{ color: pal.muted }}><X size={18} /></button>
        </div>
...
function MissionsPage({ t, pal, lang, missions }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.missions_title}</h1>
            ...
            <div className="space-y-4">
              {g.items.map((m, i) => (
                <div key={i}>
                  ...
                  <XPBar value={m.progress} max={m.total} pal={pal} />
                  <div className="flex justify-between text-xs mt-1" style={{ color: pal.muted, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>
    ...
    return (
      <LedgerPanel pal={pal}>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <button onClick={logout} className="px-3 py-1.5 rounded-xl text-xs font-medium"
            style={{ border: `1.5px solid ${pal.border}`, color: pal.inkSoft, fontFamily: "'Poppins', sans-serif" }}>
            {t.logout}
          </button>
        </div>
  ...
  return (
    <LedgerPanel pal={pal}>
      ...
      <div className="flex gap-2 mb-3">
        {[["login", t.login], ["register", t.register]].map(([key, label]) => (
          <button key={key} onClick={() => setMode(key)}
            ...
            style={{ background: mode === key ? pal.orange : pal.bgAlt, color: mode === key ? "#fff" : pal.ink, fontFamily: "'Poppins', sans-serif" }}>
            {label}
          </button>
        ))}
      </div>
      ...
      <button onClick={submit} disabled={busy || !username || !password}
        className="mt-3 w-full px-4 py-2 rounded-xl text-sm font-medium disabled:opacity-40"
        style={{ background: pal.ink, color: pal.panel, fontFamily: "'Poppins', sans-serif" }}>
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center p-4 print:p-0" style={{ background: "rgba(0,0,0,0.55)" }} onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()} className="print:shadow-none"
        style={{
          background: "#FFFFFF", color: "#12203E", width: "100%", maxWidth: 640,
          border: "3px double #C8102E", borderRadius: 20, padding: "48px 40px", position: "relative",
        }}>
        <button onClick={onClose} className="print:hidden absolute top-3 right-3" style={{ color: "#7686A3" }}>
          <X size={20} />
        </button>
        <div className="text-center">
          <div className="w-10 h-10 rounded-xl mx-auto mb-4 overflow-hidden flex flex-col">
          ...
          <div className="text-xs uppercase tracking-widest mb-1" style={{ color: "#C8102E", fontFamily: "'Poppins', sans-serif", letterSpacing: "0.18em" }}>
            Dutch Accounting Academy
          </div>
          <h1 className="text-2xl font-bold mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>{t.certificate_title}</h1>
          <div className="text-sm mb-1" style={{ color: "#7686A3" }}>{t.certificate_awarded_to}</div>
          <div className="text-xl font-semibold mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>{holderName}</div>
          <div className="text-sm mb-1" style={{ color: "#7686A3" }}>{t.certificate_for}</div>
          <div className="text-lg font-medium mb-8">{cert.title}</div>
          <div className="text-xs" style={{ color: "#7686A3" }}>
            {t.certificate_date}: {new Date().toLocaleDateString(lang === "pt" ? "pt-PT" : lang === "nl" ? "nl-NL" : "en-GB")}
          </div>
        </div>
        <button onClick={() => window.print()} className="print:hidden mt-8 w-full px-4 py-2 rounded-xl text-sm font-medium"
          style={{ background: "#C8102E", color: "#fff", fontFamily: "'Poppins', sans-serif" }}>
          {t.certificate_print}
        </button>
      </div>
    </div>
...
function CertificatePanel({ t, pal, lang, progress, account }) {
  ...
  return (
    <LedgerPanel pal={pal}>
      ...
      <div className="space-y-2">
        {certs.map((c) => (
          <div key={c.key} className="flex items-center justify-between px-3 py-2.5 rounded-xl"
            ...
            {c.earned ? (
              <button onClick={() => setOpenCert(c)} className="text-xs font-medium px-2.5 py-1 rounded-xl flex-shrink-0"
                style={{ background: pal.orange, color: "#fff", fontFamily: "'Poppins', sans-serif" }}>
                {t.view_certificate}
              </button>
            ) : (
...
function ProfilePage({ t, pal, lang, theme, setTheme, setLang, onReset, account, badges, progress }) {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold" style={{ color: pal.ink, fontFamily: "'Poppins', sans-serif" }}>{t.profile_title}</h1>
      ...
      <div className="grid md:grid-cols-3 gap-5">
        <LedgerPanel pal={pal}>
          ...
          <div className="flex gap-2">
            <button onClick={() => setTheme("light")} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-sm"
              style={{ background: theme === "light" ? pal.orange : pal.bgAlt, color: theme === "light" ? "#fff" : pal.ink }}>
              <Sun size={14} /> {t.light_mode}
            </button>
            <button onClick={() => setTheme("dark")} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-sm"
        ...
        <LedgerPanel pal={pal}>
          ...
          <div className="flex gap-2">
            {["pt", "en", "nl"].map((l) => (
              <button key={l} onClick={() => setLang(l)} className="flex-1 px-3 py-2 rounded-xl text-sm uppercase font-medium"
                style={{ background: lang === l ? pal.orange : pal.bgAlt, color: lang === l ? "#fff" : pal.ink, fontFamily: "'Poppins', sans-serif" }}>
                {l}
              </button>
            ))}
          </div>
      ...
      <LedgerPanel pal={pal}>
        ...
        <button
          ...
          style={{ border: `1.5px solid ${pal.stampRed}`, color: pal.stampRed, background: "transparent", fontFamily: "'Poppins', sans-serif" }}>
          {t.reset_progress}
        </button>
      </LedgerPanel>
    </div>
...
const LANDING_CSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  html, body { background: var(--cream); color: var(--ink); font-family: 'Inter', sans-serif; overflow-x: hidden; }
  .wrap { max-width: 1180px; margin: 0 auto; padding: 0 24px; }
  h1, h2, h3, .disp { font-family: 'Poppins', sans-serif; font-weight: 700; }

  /* ---- nav ---- */
  nav { display:flex; align-items:center; justify-content:space-between; padding:22px 0; }
  .logo { display:flex; align-items:center; gap:9px; font-family:'Poppins',sans-serif; font-weight:800; font-size:19px; color:var(--green-dark); }
  .logo-mark { width:34px; height:34px; border-radius:10px; background:var(--green); display:flex; align-items:center; justify-content:center; color:#fff; font-size:17px; flex-shrink:0; }
  .nav-links { display:flex; gap:28px; font-size:14.5px; font-weight:500; color:var(--ink-soft); }
  .nav-links a { text-decoration:none; color:inherit; }
  .btn {
    font-family:'Poppins',sans-serif; font-weight:600; font-size:14px; border:none; cursor:pointer;
    padding:11px 22px; border-radius:999px; transition:transform .12s ease, box-shadow .12s ease;
    text-decoration:none; display:inline-block; text-align:center;
  }
  .btn-primary { background:var(--green); color:#fff; box-shadow:0 6px 16px rgba(31,122,77,0.28); }
  .btn-primary:hover { transform:translateY(-2px); }
  .btn-ghost { background:transparent; color:var(--green-dark); }

  /* ---- hero ---- */
  .hero { position:relative; padding:56px 0 40px; display:grid; grid-template-columns:1.1fr 0.9fr; gap:48px; align-items:center; }
  @media (max-width:860px){ .hero{ grid-template-columns:1fr; padding-top:20px; } }
  .eyebrow { display:inline-flex; align-items:center; gap:7px; background:var(--green-soft); color:var(--green-dark);
    font-size:12.5px; font-weight:600; padding:6px 14px; border-radius:999px; margin-bottom:18px; }
  .hero h1 { font-size:clamp(32px,4.6vw,52px); line-height:1.08; color:var(--ink); margin-bottom:18px; }
  .hero h1 span { color:var(--green); }
  .hero p { font-size:16.5px; line-height:1.6; color:var(--ink-soft); max-width:480px; margin-bottom:26px; }
  .hero-ctas { display:flex; gap:12px; flex-wrap:wrap; }

  .hero-card {
    background:#fff; border-radius:24px; padding:26px; box-shadow:0 20px 50px rgba(20,83,46,0.12);
    border:1px solid var(--line); position:relative;
  }
  .hero-card .tag { display:inline-block; background:var(--green-soft); color:var(--green-dark); font-size:12px; font-weight:600; padding:4px 10px; border-radius:999px; margin-bottom:12px; }
  .hero-card h3 { font-size:20px; color:var(--ink); margin-bottom:8px; }
  .hero-card p { font-size:13.5px; color:var(--ink-soft); line-height:1.5; margin-bottom:16px; }
  .hero-card .progress-row { display:flex; align-items:center; gap:10px; }
  .progress-bar { flex:1; height:8px; border-radius:999px; background:var(--green-soft); overflow:hidden; }
  .progress-fill { height:100%; width:68%; background:var(--green); border-radius:999px; }
  .progress-pct { font-size:12.5px; font-weight:600; color:var(--green-dark); font-family:'Poppins',sans-serif; }
  .leaf { position:absolute; opacity:0.5; }

  /* ---- stats ---- */
  .stats { display:grid; grid-template-columns:repeat(3,1fr); gap:20px; padding:44px 0; }
  @media (max-width:700px){ .stats{ grid-template-columns:1fr; } }
  .stat { text-align:center; }
  .stat .num { font-family:'Poppins',sans-serif; font-weight:800; font-size:clamp(28px,4vw,38px); color:var(--green-dark); }
  ...
  .section-head h2 { font-size:clamp(24px,3.2vw,32px); color:var(--ink); margin-bottom:10px; }
  .section-head p { font-size:15px; color:var(--ink-soft); line-height:1.55; }
  ...
  .course-card:hover { transform:translateY(-4px); box-shadow:0 16px 34px rgba(20,83,46,0.12); }
  .course-icon { width:44px; height:44px; border-radius:13px; background:var(--green-soft); color:var(--green-dark);
    display:flex; align-items:center; justify-content:center; font-size:20px; margin-bottom:14px; }
  .course-card h3 { font-size:16.5px; color:var(--ink); margin-bottom:6px; }
  .course-card p { font-size:13px; color:var(--ink-soft); line-height:1.5; margin-bottom:14px; }
  .course-meta { display:flex; align-items:center; justify-content:space-between; font-size:12px; color:var(--ink-soft); font-weight:500; }
  .course-meta .free { color:var(--green-dark); font-weight:700; }
  ...
  .benefit .icon { width:56px; height:56px; border-radius:16px; background:var(--green-soft); color:var(--green-dark);
    display:flex; align-items:center; justify-content:center; font-size:24px; margin:0 auto 14px; }
  .benefit h3 { font-size:16px; color:var(--ink); margin-bottom:6px; }
  .benefit p { font-size:13.5px; color:var(--ink-soft); line-height:1.5; }

  /* ---- testimonials ---- */
  .testimonials { display:grid; grid-template-columns:repeat(3,1fr); gap:18px; }
  @media (max-width:860px){ .testimonials{ grid-template-columns:1fr; } }
  .t-card { background:#fff; border-radius:18px; padding:22px; border:1px solid var(--line); }
  .t-card .quote { font-size:24px; color:var(--green); margin-bottom:10px; font-family:'Poppins',sans-serif; }
  .t-card p { font-size:13.5px; color:var(--ink-soft); line-height:1.6; margin-bottom:16px; }
  .t-author { display:flex; align-items:center; gap:10px; }
  .t-avatar { width:36px; height:36px; border-radius:50%; background:var(--green); color:#fff; display:flex; align-items:center; justify-content:center; font-size:13px; font-weight:700; font-family:'Poppins',sans-serif; }
  .t-name { font-size:13px; font-weight:600; color:var(--ink); }

  /* ---- cta band ---- */
  .cta-band {
    background:linear-gradient(135deg, var(--green) 0%, var(--green-dark) 100%);
    border-radius:28px; padding:48px 32px; text-align:center; color:#fff; margin:20px 0 60px; position:relative; overflow:hidden;
  }
  .cta-band h2 { font-size:clamp(24px,3.4vw,32px); margin-bottom:12px; color:#fff; }
  .cta-band p { font-size:15px; opacity:0.92; max-width:480px; margin:0 auto 24px; line-height:1.55; }
  .cta-band .btn-primary { background:#fff; color:var(--green-dark); box-shadow:none; }

  footer { border-top:1px solid var(--line); padding:32px 0 40px; display:flex; align-items:center; justify-content:space-between;
...
const LANDING_BODY = `
  <div class="wrap">
    <nav>
      <div class="logo"><div class="logo-mark">🇳🇱</div>Dutch Accounting Academy</div>
      <div class="nav-links">
      ...
      <div style="display:flex; gap:10px;">
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="btn btn-ghost">Já sou aluno</a>
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="btn btn-primary">Começar grátis</a>
      </div>
    </nav>

    <section class="hero">
      <div>
        <span class="eyebrow">🇳🇱 100% gratuito · Certificado incluído</span>
        <h1>Aprende contabilidade <span>neerlandesa</span> do zero, ao teu ritmo</h1>
        <p>BTW, Vpb, Payroll, Dutch GAAP e muito mais — com lições, flashcards, quizzes e um Modo Empresa onde praticas lançamentos a sério. Grátis, para sempre.</p>
        <div class="hero-ctas">
          <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="btn btn-primary">Começar agora →</a>
          <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="btn btn-ghost">Ver currículo completo</a>
        </div>
      </div>
      <div class="hero-card">
        <span class="tag">EM CURSO</span>
        <h3>BTW — IVA Neerlandês</h3>
        <p>Taxas, reverse-charge, OSS e faturação. 10 lições, com exercícios práticos no Modo Empresa.</p>
    ...
    <section class="stats">
      <div class="stat"><div class="num">16+</div><div class="label">Módulos de contabilidade e fiscalidade</div></div>
      <div class="stat"><div class="num">80+</div><div class="label">Lições com flashcards e quizzes</div></div>
      <div class="stat"><div class="num">100%</div><div class="label">Gratuito, sem mensalidade</div></div>
    </section>

    <section class="section" id="cursos">
      <div class="section-head">
        <h2>Currículo completo, sem pagar nada</h2>
        <p>Do zero à prática — cada módulo tem teoria, flashcards e um quiz para consolidar.</p>
      </div>
      <div class="courses">
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="course-card">
          <div class="course-icon">📊</div>
          <h3>BTW — IVA Neerlandês</h3>
          <p>Taxas, reverse-charge, ICP, OSS e faturação eletrónica.</p>
          <div class="course-meta"><span>10 lições</span><span class="free">Grátis</span></div>
        </a>
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="course-card">
          <div class="course-icon">🏛️</div>
          <h3>Corporate Tax (Vpb)</h3>
          <p>Escalões, participation exemption, innovatiebox e fiscale eenheid.</p>
          <div class="course-meta"><span>6 lições</span><span class="free">Grátis</span></div>
        </a>
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="course-card">
          <div class="course-icon">💰</div>
          <h3>Payroll Neerlandês</h3>
          <p>Loonheffing, regra dos 30%, vakantiegeld e contratos de trabalho.</p>
          <div class="course-meta"><span>6 lições</span><span class="free">Grátis</span></div>
        </a>
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="course-card">
          <div class="course-icon">📘</div>
          <h3>Dutch GAAP</h3>
          <p>BW2 Titel 9, classificação por dimensão e demonstrações financeiras.</p>
          <div class="course-meta"><span>6 lições</span><span class="free">Grátis</span></div>
        </a>
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="course-card">
          <div class="course-icon">🌍</div>
          <h3>IFRS</h3>
          <p>Conceptual Framework, recognition, measurement e disclosure.</p>
          <div class="course-meta"><span>Em crescimento</span><span class="free">Grátis</span></div>
        </a>
        <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="course-card">
          <div class="course-icon">🏢</div>
          <h3>Modo Empresa</h3>
          <p>Pratica lançamentos reais numa empresa fictícia, com correção automática.</p>
          <div class="course-meta"><span>7 tarefas</span><span class="free">Grátis</span></div>
        </a>
      </div>
    </section>
    ...
    <section class="section" id="beneficios">
      <div class="section-head">
        <h2>Porque estudar na Dutch Accounting Academy</h2>
      </div>
      <div class="benefits">
        <div class="benefit">
          <div class="icon">🔓</div>
          <h3>Acesso livre e para sempre</h3>
          <p>Todos os módulos disponíveis sem mensalidade, sem limite de tempo.</p>
        </div>
        <div class="benefit">
          <div class="icon">🧩</div>
          <h3>Aprender fazendo</h3>
          <p>Flashcards, quizzes e um Modo Empresa com exercícios de lançamento reais.</p>
        </div>
        <div class="benefit">
          <div class="icon">🏆</div>
          <h3>Progressão de carreira</h3>
          <p>Sobe de Intern a CFO, com XP, níveis e missões — aprende como se estivesses a jogar.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section" id="depoimentos">
      <div class="section-head">
        <h2>Quem já estuda connosco</h2>
      </div>
      <div class="testimonials">
        <div class="t-card">
          <div class="quote">"</div>
          <p>Finalmente um sítio onde percebo a diferença entre o BTW português e o neerlandês, com exemplos a sério, não só teoria.</p>
          <div class="t-author"><div class="t-avatar">M</div><div class="t-name">Maximiano B.</div></div>
        </div>
        <div class="t-card">
          <div class="quote">"</div>
          <p>O Modo Empresa é o que fazia falta — pratico o lançamento em vez de só ler sobre ele.</p>
          <div class="t-author"><div class="t-avatar">A</div><div class="t-name">Aluno Beta</div></div>
        </div>
        <div class="t-card">
          <div class="quote">"</div>
          <p>Gosto de poder escolher entre português, inglês e neerlandês sem perder o fio à meada.</p>
          <div class="t-author"><div class="t-avatar">S</div><div class="t-name">Aluna Beta</div></div>
        </div>
      </div>
    </section>
    ...
    <section class="cta-band">
      ...
      <p>Cria a tua conta grátis e começa já a primeira lição — sem cartão de crédito, sem letras pequenas.</p>
      <a href="javascript:void(0)" onclick="window.__daaEnterApp && window.__daaEnterApp()" class="btn btn-primary">Criar conta grátis →</a>
    </section>

    <footer>
      <span>Dutch Accounting Academy · feito para quem quer trabalhar na Holanda</span>
      <span>dutch-accounting-academy.vercel.app</span>
    </footer>
  </div>
`;
  ...
  return (
    <div className="overflow-x-hidden" style={{ background: pal.bg, minHeight: "100vh", fontFamily: "'Inter', sans-serif", color: pal.ink }}>
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 py-3 sticky top-0 z-20" style={{ background: pal.bgAlt, borderBottom: `1px solid ${pal.border}` }}>
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-xl overflow-hidden flex flex-col flex-shrink-0" aria-hidden>
          ...
          <span className="font-semibold text-sm hidden sm:block" style={{ fontFamily: "'Poppins', sans-serif" }}>Dutch Accounting Academy</span>
        </div>
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-1.5 text-xs" style={{ color: pal.muted, fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace" }}>
          ...
          <div className="flex gap-1">
            {["pt", "en", "nl"].map((l) => (
              <button key={l} onClick={() => setLang(l)} className="text-xs px-1.5 py-0.5 rounded-xl uppercase font-medium"
                style={{ background: lang === l ? pal.orange : "transparent", color: lang === l ? "#fff" : pal.muted, fontFamily: "'Poppins', sans-serif" }}>
                {l}
              </button>
            ))}
          </div>
      ...
      <div className="flex">
        <div className="hidden md:flex flex-col gap-1 py-6 pl-3 pr-1" style={{ minWidth: 168 }}>
          {NAV.map((n) => {
            ...
            const Icon = n.icon;
            return (
              <button key={n.key} onClick={() => setTab(n.key)} className="flex items-center gap-2.5 px-3.5 py-2.5 text-sm text-left transition-all rounded-xl"
                style={{
                  color: active ? "#fff" : pal.inkSoft, background: active ? pal.orange : "transparent",
          ...
          return (
            <button key={n.key} onClick={() => setTab(n.key)}
              ...
              <span className="text-[10px] leading-none font-medium text-center px-0.5"
                style={{ fontFamily: "'Poppins', sans-serif" }}>{n.label}</span>
            </button>
          );
        })}
      </nav>
